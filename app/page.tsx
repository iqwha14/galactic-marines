...
import OpsPanel from "./_components/OpsPanel";
...
function InnerApp() {
  ...
  const [tab, setTab] = useState<"members" | "absences" | "docs" | "ops" | "uo" | "log" | "adjutant">("members");
      ...
      <header className="mb-8">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <h1 className="mt-2 text-3xl font-semibold">Galactic Marines Dashboard</h1>
