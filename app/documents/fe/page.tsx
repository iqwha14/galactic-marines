...
export default function FEDocPage() {
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      setErr(null);
      try {
        const res = await fetch("/api/fe-doc", { method: "POST" });
  ...
  return (
    <main className="min-h-screen hud-grid px-6 py-10">
      <div className="mx-auto max-w-6xl">
        <TopBar title="Führungsebene Dokument" subtitle="ARCHIVE / FE" right={<Link href="/documents" className="btn btn-ghost">← Dokumente</Link>} />
